    ...
    <div className="w-full max-w-6xl mx-auto">
      <div className="grid md:grid-cols-2 gap-8 items-center">
        ...
        <div className="space-y-6">
          {selectedCity ? (
            <div className="bg-white rounded-3xl p-8 shadow-xl border-2 border-blue-100 animate-fade-in">
            ...
            <div className="bg-gradient-to-br from-gray-50 to-blue-50 rounded-3xl p-8 border-2 border-dashed border-gray-300">
